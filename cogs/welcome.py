...
class WSetupM(discord.ui.Modal, title = "Welcome Setup"):
    ...
    ch = ui.TextInput(label="Channel ID",)
    msg = ui.TextInput(label='Welcome Message', style = discord.TextStyle.paragraph, required = False)
    emb = ui.TextInput(label='Welcome Embed(json format)', style = discord.TextStyle.paragraph, required = False)
    ...
    async def on_submit(self, i: discord.Interaction):
        ...
        await i.response.send_message("You have successfully set up the welcome system!")
...
class WelcomeCog(commands.Cog, name = "Welcome"):
    ...
    async def cog_load(self):
        self.db = db = await aiosqlite.connect(
            "db/welcome.sqlite"
        )
        async with db.execute(
